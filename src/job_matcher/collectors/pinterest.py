...
PINTEREST_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/pinterest/jobs"


def parse_pinterest_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or PINTEREST_CAREERS_URL
