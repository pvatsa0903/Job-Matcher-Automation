...
AIRBNB_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/airbnb/jobs"


def parse_airbnb_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or AIRBNB_CAREERS_URL
