...
DOORDASH_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/doordash/jobs"


def parse_doordash_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or DOORDASH_CAREERS_URL
