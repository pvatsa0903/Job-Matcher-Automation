...
INSTACART_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/instacart/jobs"


def parse_instacart_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or INSTACART_CAREERS_URL
