...
NOTION_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/notion/jobs"


def parse_notion_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or NOTION_CAREERS_URL
