...
SNAP_CAREERS_URL = "https://careers.snap.com/jobs"


def parse_snap_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        posted_at = parse_datetime(job.get("postedOn") or job.get("postedDate"))
        ...
        if path.startswith("http"):
            ...
            url = f"https://careers.snap.com{path}"
        else:
            url = SNAP_CAREERS_URL
