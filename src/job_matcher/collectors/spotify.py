...
SPOTIFY_CAREERS_URL = "https://boards-api.greenhouse.io/v1/boards/spotify/jobs"


def parse_spotify_jobs(payload: dict[str, Any], *, now: datetime | None = None) -> list[JobPosting]:
    ...
    for job in jobs:
        ...
        url = str(job.get("absolute_url", "")).strip() or SPOTIFY_CAREERS_URL
